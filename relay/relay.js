// FILE: relay.js
// Purpose: Thin self-hostable WebSocket relay for pocketex pairing, trusted-session lookup, and encrypted forwarding.
...
const TRUSTED_SESSION_RESOLVE_TAG = "pocketex-trusted-session-resolve-v1";
