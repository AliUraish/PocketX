// FILE: AboutPocketexView.swift
// Purpose: Full-screen guide explaining how pocketex works, styled as a blog page.
// Layer: View
// Exports: AboutPocketexView

import SwiftUI

struct AboutPocketexView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .font(AppFont.body())
            .navigationTitle("About pocketex")
    ...
    @ViewBuilder private var architectureDiagram: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            VStack(spacing: 0) {
                diagramStep(from: "pocketex iOS", to: "Bridge (Mac)", via: "WebSocket")
    ...
    @ViewBuilder private var relaySection: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            bodyText("You can run the relay on a Tailscale-reachable Mac, LAN host, or self-hosted VPS. pocketex does not assume a hosted default relay.")
        }
    }
    ...
    @ViewBuilder private var appServerSection: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            calloutCard(
                ...
                color: .orange,
                text: "Already have a running Codex instance? Point the bridge at it with POCKETEX_CODEX_ENDPOINT instead of spawning a new one."
            )
        }
    }
